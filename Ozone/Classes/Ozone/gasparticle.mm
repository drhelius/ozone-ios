...
GasParticle::GasParticle(void) : Particle() { }

//////////////////////////
//////////////////////////

void GasParticle::Init(void)
{
    m_MainRenderObject.Init(MeshManager::Instance().GetMeshFromFile("game/entities/gas"),
...
void GasParticle::Update(Timer* timer)
{
    if (!m_bDead)
    {
