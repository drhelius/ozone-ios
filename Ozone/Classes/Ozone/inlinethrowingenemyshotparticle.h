...
/* 
 * File:   inlinethrowingenemyshotparticle.h
 * Author: nacho
 *
...
#pragma once
#ifndef _INLINETHROWINGENEMYSHOTPARTICLE_H
#define	_INLINETHROWINGENEMYSHOTPARTICLE_H

#include "particle.h"

class InlineThrowingEnemyShotParticle : public Particle
{
public:
    InlineThrowingEnemyShotParticle(void);
...
#endif	/* _INLINETHROWINGENEMYSHOTPARTICLE_H */
