...
/* 
 * File:   BossSpaceShotParticle.h
 * Author: nacho
 *
 * Created on 22 de marzo de 2010, 16:24
 */

#ifndef _BOSSSPACESHOTPARTICLE_H
#define	_BOSSSPACESHOTPARTICLE_H

#include "particle.h"

class BossSpaceShotParticle : public Particle
{
public:
    BossSpaceShotParticle(void);
...
#endif	/* _BOSSSPACESHOTPARTICLE_H */
