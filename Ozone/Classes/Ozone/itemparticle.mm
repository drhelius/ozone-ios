...
ItemParticle::ItemParticle(void) : Particle() { }

//////////////////////////
//////////////////////////

void ItemParticle::Init(void)
{
    m_MainRenderObject.Init(MeshManager::Instance().GetMeshFromFile("game/entities/particle_04"),
            TextureManager::Instance().GetTexture("game/entities/particles", true), RENDER_OBJECT_ADDITIVE);
...
void ItemParticle::Update(Timer* timer)
{
    if (!m_bDead)
    {
...
void ItemParticle::Disable(void)
{
    Particle::Disable();
}
